# Generated by Django 4.2.25 on 2025-11-21 14:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Клієнт'), ('psychologist', 'Психолог'), ('guest', 'Гість'), ('admin', 'Адміністратор')], default='guest', max_length=20)),
                ...
                ('document_number', models.CharField(blank=True, max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience', models.IntegerField(default=0, verbose_name='Стаж (років)')),
                ...
                ('languages', models.CharField(blank=True, max_length=100, verbose_name='Мови')),
                ('response_time', models.CharField(blank=True, max_length=20, verbose_name='Час відповіді')),
